...
## Plot 1, trying to recreate the looks of the example one!
png(file="plot1.png", height=480, width=480)

hist(hh_data$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
